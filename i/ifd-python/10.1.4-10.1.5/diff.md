# Comparing `tmp/ifd_python-10.1.4.tar.gz` & `tmp/ifd_python-10.1.5.tar.gz`
...
### Comparing `ifd_python-10.1.4/ifd/repository/SqlLogRepository.py` & `ifd_python-10.1.5/ifd/repository/SqlLogRepository.py`

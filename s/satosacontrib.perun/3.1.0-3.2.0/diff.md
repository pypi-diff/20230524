# Comparing `tmp/satosacontrib.perun-3.1.0.tar.gz` & `tmp/satosacontrib.perun-3.2.0.tar.gz`
...
### Comparing `satosacontrib.perun-3.1.0/LICENSE` & `satosacontrib.perun-3.2.0/LICENSE`

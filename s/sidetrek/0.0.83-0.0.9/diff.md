# Comparing `tmp/sidetrek-0.0.83.tar.gz` & `tmp/sidetrek-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "sidetrek-0.0.83.tar", max compression
+gzip compressed data, was "sidetrek-0.0.9.tar", max compression
```

## Comparing `sidetrek-0.0.83.tar` & `sidetrek-0.0.9.tar`

### file list

```diff
@@ -1,21 +1,18 @@
--rw-r--r--   0        0        0       27 2023-03-09 16:33:17.090578 sidetrek-0.0.83/README.md
--rw-r--r--   0        0        0      776 2023-05-23 22:38:09.965112 sidetrek-0.0.83/pyproject.toml
--rw-r--r--   0        0        0      604 2023-05-21 17:56:16.028060 sidetrek-0.0.83/sidetrek/__init__.py
--rw-r--r--   0        0        0     2102 2023-05-23 22:37:20.019721 sidetrek-0.0.83/sidetrek/cli.py
--rw-r--r--   0        0        0        0 2023-03-13 16:42:41.918418 sidetrek-0.0.83/sidetrek/cli_commands/__init__.py
--rw-r--r--   0        0        0      174 2023-03-14 03:00:43.940526 sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/__init__.cpython-310.pyc
--rw-r--r--   0        0        0      388 2023-03-30 16:36:26.685225 sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/constants.cpython-310.pyc
--rw-r--r--   0        0        0     8815 2023-04-06 20:18:36.881239 sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/helpers.cpython-310.pyc
--rw-r--r--   0        0        0     2395 2023-04-06 20:18:55.453228 sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/workflow.cpython-310.pyc
--rw-r--r--   0        0        0      161 2023-05-21 20:54:49.328467 sidetrek-0.0.83/sidetrek/cli_commands/constants.py
--rw-r--r--   0        0        0    10668 2023-05-21 21:04:05.995911 sidetrek-0.0.83/sidetrek/cli_commands/helpers.py
--rw-r--r--   0        0        0     3594 2023-05-23 22:33:37.993076 sidetrek-0.0.83/sidetrek/cli_commands/workflow.py
--rw-r--r--   0        0        0       37 2023-04-02 20:04:34.987724 sidetrek-0.0.83/sidetrek/constants.py
--rw-r--r--   0        0        0     1114 2023-05-03 16:51:33.053983 sidetrek-0.0.83/sidetrek/datapipes.py
--rw-r--r--   0        0        0     4317 2023-05-22 17:35:27.418133 sidetrek-0.0.83/sidetrek/dataset.py
--rw-r--r--   0        0        0       15 2023-05-03 16:06:32.112969 sidetrek-0.0.83/sidetrek/flyte/__init__.py
--rw-r--r--   0        0        0      874 2023-05-09 03:56:32.928519 sidetrek-0.0.83/sidetrek/global_fns.py
--rw-r--r--   0        0        0      661 2023-04-09 00:09:05.853814 sidetrek-0.0.83/sidetrek/loggers.py
--rw-r--r--   0        0        0        0 2023-05-07 17:03:01.499766 sidetrek-0.0.83/sidetrek/types/__init__.py
--rw-r--r--   0        0        0      642 2023-05-22 15:17:38.985798 sidetrek-0.0.83/sidetrek/types/dataset.py
--rw-r--r--   0        0        0      879 1970-01-01 00:00:00.000000 sidetrek-0.0.83/PKG-INFO
...
### Comparing `sidetrek-0.0.83/pyproject.toml` & `sidetrek-0.0.9/pyproject.toml`
...
### Comparing `sidetrek-0.0.83/sidetrek/__init__.py` & `sidetrek-0.0.9/sidetrek/__init__.py`
...
### Comparing `sidetrek-0.0.83/sidetrek/cli.py` & `sidetrek-0.0.9/sidetrek/cli.py`
...
### Comparing `sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/helpers.cpython-310.pyc` & `sidetrek-0.0.9/sidetrek/cli_commands/__pycache__/helpers.cpython-310.pyc`

 * *Files identical despite different names*

### Comparing `sidetrek-0.0.83/sidetrek/cli_commands/__pycache__/workflow.cpython-310.pyc` & `sidetrek-0.0.9/sidetrek/cli_commands/__pycache__/workflow.cpython-310.pyc`

 * *Files identical despite different names*

### Comparing `sidetrek-0.0.83/sidetrek/cli_commands/helpers.py` & `sidetrek-0.0.9/sidetrek/cli_commands/helpers.py`
...
### Comparing `sidetrek-0.0.83/sidetrek/cli_commands/workflow.py` & `sidetrek-0.0.9/sidetrek/cli_commands/workflow.py`
...
### Comparing `sidetrek-0.0.83/sidetrek/loggers.py` & `sidetrek-0.0.9/sidetrek/loggers/loggers.py`

# Comparing `tmp/falocalrepo-4.4.2.tar.gz` & `tmp/falocalrepo-4.4.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "falocalrepo-4.4.2.tar", max compression
+gzip compressed data, was "falocalrepo-4.4.3.tar", max compression
```

## Comparing `falocalrepo-4.4.2.tar` & `falocalrepo-4.4.3.tar`

### file list

```diff
@@ -1,16 +1,16 @@
--rw-r--r--   0        0        0    13866 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/LICENSE
--rw-r--r--   0        0        0    36954 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/README.md
--rwxr-xr-x   0        0        0       62 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/__init__.py
--rwxr-xr-x   0        0        0     2822 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/__main__.py
--rw-r--r--   0        0        0       22 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/__version__.py
--rw-r--r--   0        0        0       21 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/__init__.py
--rw-r--r--   0        0        0    17333 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/app.py
--rw-r--r--   0        0        0     6318 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/colors.py
--rw-r--r--   0        0        0     9209 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/config.py
--rw-r--r--   0        0        0    65069 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/database.py
--rw-r--r--   0        0        0    18296 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/download.py
--rw-r--r--   0        0        0    10427 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/console/util.py
--rw-r--r--   0        0        0    38539 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/falocalrepo/downloader.py
--rw-r--r--   0        0        0     1544 2022-11-27 22:32:47.166760 falocalrepo-4.4.2/pyproject.toml
--rw-r--r--   0        0        0    39080 1970-01-01 00:00:00.000000 falocalrepo-4.4.2/setup.py
--rw-r--r--   0        0        0    38739 1970-01-01 00:00:00.000000 falocalrepo-4.4.2/PKG-INFO
+-rw-r--r--   0        0        0    13866 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/LICENSE
+-rw-r--r--   0        0        0    36954 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/README.md
+-rwxr-xr-x   0        0        0       62 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/__init__.py
+-rwxr-xr-x   0        0        0     2822 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/__main__.py
+-rw-r--r--   0        0        0       22 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/__version__.py
+-rw-r--r--   0        0        0       21 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/__init__.py
+-rw-r--r--   0        0        0    17333 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/app.py
+-rw-r--r--   0        0        0     6318 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/colors.py
+-rw-r--r--   0        0        0     9209 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/config.py
+-rw-r--r--   0        0        0    65069 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/database.py
+-rw-r--r--   0        0        0    18316 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/download.py
+-rw-r--r--   0        0        0    10427 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/console/util.py
+-rw-r--r--   0        0        0    38619 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/falocalrepo/downloader.py
+-rw-r--r--   0        0        0     1544 2022-12-18 11:32:38.168888 falocalrepo-4.4.3/pyproject.toml
+-rw-r--r--   0        0        0    39080 1970-01-01 00:00:00.000000 falocalrepo-4.4.3/setup.py
+-rw-r--r--   0        0        0    38739 1970-01-01 00:00:00.000000 falocalrepo-4.4.3/PKG-INFO
```

### Comparing `falocalrepo-4.4.2/LICENSE` & `falocalrepo-4.4.3/LICENSE`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/README.md` & `falocalrepo-4.4.3/README.md`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/__main__.py` & `falocalrepo-4.4.3/falocalrepo/__main__.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/console/app.py` & `falocalrepo-4.4.3/falocalrepo/console/app.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/console/colors.py` & `falocalrepo-4.4.3/falocalrepo/console/colors.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/console/config.py` & `falocalrepo-4.4.3/falocalrepo/console/config.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/console/database.py` & `falocalrepo-4.4.3/falocalrepo/console/database.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/console/download.py` & `falocalrepo-4.4.3/falocalrepo/console/download.py`
...
### Comparing `falocalrepo-4.4.2/falocalrepo/console/util.py` & `falocalrepo-4.4.3/falocalrepo/console/util.py`

 * *Files identical despite different names*

### Comparing `falocalrepo-4.4.2/falocalrepo/downloader.py` & `falocalrepo-4.4.3/falocalrepo/downloader.py`
...
### Comparing `falocalrepo-4.4.2/pyproject.toml` & `falocalrepo-4.4.3/pyproject.toml`
...
@@ -26,15 +26,15 @@
 ...
 python = "^3.10"
 faapi = "~3.10.0"
-falocalrepo-database = "~5.4.3"
+falocalrepo-database = "~5.4.4"
 falocalrepo-server = "~3.3.3"
 psutil = "^5.9.3"
 click = "^8.1.3"
...
### Comparing `falocalrepo-4.4.2/setup.py` & `falocalrepo-4.4.3/setup.py`
...
@@ -7,27 +7,27 @@
 ...
 ['click-help-colors>=0.9.1,<0.10.0',
  'click>=8.1.3,<9.0.0',
  'faapi>=3.10.0,<3.11.0',
- 'falocalrepo-database>=5.4.3,<5.5.0',
+ 'falocalrepo-database>=5.4.4,<5.5.0',
  'falocalrepo-server>=3.3.3,<3.4.0',
...
### Comparing `falocalrepo-4.4.2/PKG-INFO` & `falocalrepo-4.4.3/PKG-INFO`
...
-Version: 4.4.2
+Version: 4.4.3
 Summary: Pure Python program to download any user's gallery, scraps, favorites, and journals from FurAffinity in an easily handled database.
 Home-page: https://github.com/FurryCoders/FALocalRepo
 License: EUPL-1.2
 Author: Matteo Campinoti
...
@@ -16,15 +16,15 @@
 ...
 Requires-Dist: faapi (>=3.10.0,<3.11.0)
-Requires-Dist: falocalrepo-database (>=5.4.3,<5.5.0)
+Requires-Dist: falocalrepo-database (>=5.4.4,<5.5.0)
 Requires-Dist: falocalrepo-server (>=3.3.3,<3.4.0)
 Requires-Dist: pretty-errors (>=1.2.25,<2.0.0)
 Requires-Dist: psutil (>=5.9.3,<6.0.0)
 Requires-Dist: supports-color (>=0.1.2,<0.2.0)
 Requires-Dist: wcwidth (>=0.2.5,<0.3.0)
 Project-URL: Bug Reports, https://github.com/FurryCoders/FALocalRepo/issues
 Project-URL: Changelog, https://github.com/FurryCoders/FALocalRepo/blob/main/CHANGELOG.md
```

# Comparing `tmp/cdsspy-1.2.67.tar.gz` & `tmp/cdsspy-1.2.68.tar.gz`
...
## Comparing `cdsspy-1.2.67.tar` & `cdsspy-1.2.68.tar`
...
### Comparing `cdsspy-1.2.67/LICENSE` & `cdsspy-1.2.68/LICENSE`

 * *Files identical despite different names*

### Comparing `cdsspy-1.2.67/PKG-INFO` & `cdsspy-1.2.68/PKG-INFO`
...
### Comparing `cdsspy-1.2.67/README.md` & `cdsspy-1.2.68/README.md`

 * *Files identical despite different names*

### Comparing `cdsspy-1.2.67/setup.py` & `cdsspy-1.2.68/setup.py`
...
### Comparing `cdsspy-1.2.67/src/cdsspy/cdsspy.egg-info/PKG-INFO` & `cdsspy-1.2.68/cdsspy/src/cdsspy.egg-info/PKG-INFO`

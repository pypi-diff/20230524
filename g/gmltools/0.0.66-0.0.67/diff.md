# Comparing `tmp/gmltools-0.0.66.tar.gz` & `tmp/gmltools-0.0.67.tar.gz`
...
### Comparing `gmltools-0.0.66/PKG-INFO` & `gmltools-0.0.67/PKG-INFO`
...
### Comparing `gmltools-0.0.66/setup.py` & `gmltools-0.0.67/setup.py`

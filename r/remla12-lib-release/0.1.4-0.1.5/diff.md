# Comparing `tmp/remla12_lib_release-0.1.4.tar.gz` & `tmp/remla12_lib_release-0.1.5.tar.gz`
...
+gzip compressed data, was "remla12_lib_release-0.1.5.tar", last modified: Wed May 24 17:24:56 2023, max compression
```

## Comparing `remla12_lib_release-0.1.4.tar` & `remla12_lib_release-0.1.5.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:24:56.433873 remla12_lib_release-0.1.5/
+-rw-r--r--   0 runner    (1001) docker     (123)      679 2023-05-24 17:24:56.433873 remla12_lib_release-0.1.5/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      449 2023-05-24 17:24:47.000000 remla12_lib_release-0.1.5/README.md
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:24:56.433873 remla12_lib_release-0.1.5/remla12_lib_release/
+-rw-r--r--   0 runner    (1001) docker     (123)      101 2023-05-24 17:24:47.000000 remla12_lib_release-0.1.5/remla12_lib_release/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (123)      139 2023-05-24 17:24:47.000000 remla12_lib_release-0.1.5/remla12_lib_release/version_util.py
+drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-24 17:24:56.433873 remla12_lib_release-0.1.5/remla12_lib_release.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (123)      679 2023-05-24 17:24:56.000000 remla12_lib_release-0.1.5/remla12_lib_release.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (123)      258 2023-05-24 17:24:56.000000 remla12_lib_release-0.1.5/remla12_lib_release.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-24 17:24:56.000000 remla12_lib_release-0.1.5/remla12_lib_release.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       20 2023-05-24 17:24:56.000000 remla12_lib_release-0.1.5/remla12_lib_release.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (123)       38 2023-05-24 17:24:56.433873 remla12_lib_release-0.1.5/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (123)      455 2023-05-24 17:24:47.000000 remla12_lib_release-0.1.5/setup.py
```

### Comparing `remla12_lib_release-0.1.4/PKG-INFO` & `remla12_lib_release-0.1.5/PKG-INFO`
...
### Comparing `remla12_lib_release-0.1.4/remla12_lib_release.egg-info/PKG-INFO` & `remla12_lib_release-0.1.5/remla12_lib_release.egg-info/PKG-INFO`
